    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-userSessions">
                    <thead>
                        <tr>
                            <th width="10">
                        ...
                        <th>
                            ...
                            <th>
                                {{ trans('cruds.session.fields.location') }}
                            </th>
                            <th>
                                {{ trans('cruds.session.fields.status') }}
                            </th>
                            <th>
                                {{ trans('cruds.session.fields.attachments') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
                    ...
                    <tbody>
                        @foreach($sessions as $key => $session)
                            <tr data-entry-id="{{ $session->id }}">
                                ...
                                <td>
                                    {{ App\Models\Session::STATUS_RADIO[$session->status] ?? '' }}
                                </td>
                                <td>
...
@endcan
  ...
  let table = $('.datatable-userSessions:not(.ajaxTable)').DataTable({ buttons: dtButtons })
