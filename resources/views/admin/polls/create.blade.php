    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.polls.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('question_groups') ? 'is-invalid' : '' }}" name="question_groups[]" id="question_groups" multiple>
                    @foreach($question_groups as $id => $question_group)
                        <option value="{{ $id }}" {{ in_array($id, old('question_groups', [])) ? 'selected' : '' }}>{{ $question_group }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('label_1') ? 'is-invalid' : '' }}" type="text" name="label_1" id="label_1" value="{{ old('label_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('label_2') ? 'is-invalid' : '' }}" type="text" name="label_2" id="label_2" value="{{ old('label_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('label_3') ? 'is-invalid' : '' }}" type="text" name="label_3" id="label_3" value="{{ old('label_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('label_4') ? 'is-invalid' : '' }}" type="text" name="label_4" id="label_4" value="{{ old('label_4', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('label_5') ? 'is-invalid' : '' }}" type="text" name="label_5" id="label_5" value="{{ old('label_5', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('use_age_score') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="use_age_score" id="use_age_score" value="1" {{ old('use_age_score', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('use_language_score') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="use_language_score" id="use_language_score" value="1" {{ old('use_language_score', 0) == 1 ? 'checked' : '' }}>
