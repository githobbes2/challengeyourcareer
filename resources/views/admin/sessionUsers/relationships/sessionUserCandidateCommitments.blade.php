    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-sessionUserCandidateCommitments">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($candidateCommitments as $key => $candidateCommitment)
                            <tr data-entry-id="{{ $candidateCommitment->id }}">
                                ...
                                <th>{{ $candidateCommitment->title ?? '' }}</td>
...
@endcan
  ...
  let table = $('.datatable-sessionUserCandidateCommitments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
