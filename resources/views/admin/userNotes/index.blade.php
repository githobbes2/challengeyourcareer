...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-UserNote">
                <thead>
                    <tr>
                        <th width="10">

                        </th>
                        <th>{{ trans('cruds.userNote.fields.user') }}</th>
...
@endcan
  ...
  let table = $('.datatable-UserNote:not(.ajaxTable)').DataTable({ buttons: dtButtons })
