...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.serviceItem.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.service-items.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('objective') ? 'is-invalid' : '' }}" type="text" name="objective" id="objective" value="{{ old('objective', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phase') ? 'is-invalid' : '' }}" type="text" name="phase" id="phase" value="{{ old('phase', '') }}">
                @if($errors->has('phase'))
