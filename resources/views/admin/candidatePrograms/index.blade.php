...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-CandidateProgram">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach(App\Models\CandidateProgram::STATUS_RADIO as $key => $item)
                ...
                <tbody>
                    @foreach($candidatePrograms as $key => $candidateProgram)
                        <tr data-entry-id="{{ $candidateProgram->id }}">
                            ...
                            <td>{{ $candidateProgram->candidate->user->full_name ?? '' }}</td>
...
@endcan
  ...
  let table = $('.datatable-CandidateProgram:not(.ajaxTable)').DataTable({ buttons: dtButtons })
