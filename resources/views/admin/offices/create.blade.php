...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.offices.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="city_id">{{ trans('cruds.office.fields.city') }}</label>
            ...
            <div class="form-group">
                <label for="notes">{{ trans('cruds.office.fields.notes') }}</label>
                <textarea class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{{ old('notes') }}</textarea>
                @if($errors->has('notes'))
                    <span class="text-danger">{{ $errors->first('notes') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.office.fields.notes_helper') }}</span>
            </div>
            <div class="form-group">
