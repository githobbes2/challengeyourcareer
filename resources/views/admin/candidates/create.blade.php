...
<div class="card">
    ...
    <div class="card-body">
        <form autocomplete="off" method="POST" action="{{ route("admin.candidates.store") }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('system_language') ? 'is-invalid' : '' }}" name="system_language_id" id="system_language_id">
                            @foreach($system_languages as $id => $entry)
                                <option value="{{ $id }}" {{ old('system_language_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                            @endforeach
                        </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('send_notification') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="send_notification" value="0">
                    <input class="form-check-input" type="checkbox" name="send_notification" id="send_notification" value="1" {{ old('send_notification', 0) == 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="send_notification">{{ trans('cruds.candidate.fields.send_notification') }}</label>
                </div>
                @if($errors->has('send_notification'))
                    <span class="text-danger">{{ $errors->first('send_notification') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.candidate.fields.send_notification_helper') }}</span>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('government_number') ? 'is-invalid' : '' }}" type="text" name="government_number" id="government_number" value="{{ old('government_number', '') }}">
            ...
            <div class="card bg-light">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has('target_companies') ? 'is-invalid' : '' }}" name="target_companies" id="target_companies">{{ old('target_companies') }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('program_aftersave') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="program_aftersave" value="0">
                    <input class="form-check-input" type="checkbox" name="program_aftersave" id="program_aftersave" value="1" {{ old('program_aftersave', 1) == 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="program_aftersave">Después de guardar, continuar a vincular al candidato a un programa</label>
                </div>
                @if($errors->has('program_aftersave'))
                    <span class="text-danger">{{ $errors->first('program_aftersave') }}</span>
                @endif
            </div>
