    ...
    <div class="card">
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-candidateCandidateCommitments">
                    <thead>
                        <tr>
                            <th>
                                {{ trans('cruds.candidateCommitment.fields.title') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidateCommitment.fields.session_user') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidateCommitment.fields.complete') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidateCommitment.fields.completion_date') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidateCommitment.fields.tag') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
...
@endcan
  ...
  let table = $('.datatable-candidateCandidateCommitments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
