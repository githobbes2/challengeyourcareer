    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-tagCandidates">
                    <thead>
                        <tr>
                            <th width="10">
                        ...
                        <th>
                                {{ trans('cruds.candidate.fields.company') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidate.fields.city') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidate.fields.curriculum') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidate.fields.tag') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidate.fields.education_level') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidate.fields.professional_level') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidate.fields.functional_area') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidate.fields.industry_sector') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidate.fields.position') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidate.fields.related_company') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidate.fields.gender') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidate.fields.disability') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidate.fields.immigrant') }}
                            </th>
                            <th>
                                {{ trans('cruds.candidate.fields.employability_score') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
...
@endcan
  ...
  let table = $('.datatable-tagCandidates:not(.ajaxTable)').DataTable({ buttons: dtButtons })
