...
<body class="sidebar-mini layout-fixed {{ \Auth::user()->is_consultant ? 'sidebar-collapse' : '' }}" style="height: auto;">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
            ...
            <a class="btn btn-light" href="{{ route("admin.home") }}">{{ trans('global.dashboard') }}</a>
